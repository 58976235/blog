...
const components = {
  ...
  HeaderTopNav: () => import('../..\\components\\header\\topNav\\index.vue' /* webpackChunkName: "components/header-top-nav" */).then(c => wrapFunctional(c.default || c)),
